...
9. **统计分析**：资产结构分析、负债结构分析、资产负债按到期日趋势、按到期日汇总表、负债率计算、净资产趋势、分类对比，支持打印全部统计图表
...
| 统计分析 | 资产负债按到期日趋势 | 折线图展示按资产/负债到期日汇总的资产、负债、净资产走势 |
...
| 统计分析 | 按到期日汇总 | 资产按到期日汇总（无到期日归入当前月份次月），负债按到期/还款日分组到月份，汇总金额正确 |
