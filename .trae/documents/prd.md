...
10. **设置**：指定数据库文件存放位置，支持切换/恢复默认位置，切换后自动重新加载数据；支持按筛选条件打印资产/负债明细
...
| 设置 | 打印资产明细 | 按分类、机构名称/银行名称/资产名称、户名、定/活期筛选后打印资产明细表 |
| 设置 | 打印负债明细 | 按分类、贷款名称/发卡机构/负债名称、户名筛选后打印负债明细表 |
...
| 设置 | 打印资产明细 | 在设置页可按分类、机构名称/银行名称/资产名称、户名、定/活期筛选并打印资产明细 |
| 设置 | 打印负债明细 | 在设置页可按分类、名称、户名筛选并打印负债明细 |
